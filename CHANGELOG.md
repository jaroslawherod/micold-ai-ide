...
## [0.13.0](https://github.com/jaroslawherod/micold-ai-ide/compare/micold-ai-ide-v0.12.1...micold-ai-ide-v0.13.0) (2026-08-27)
...
* add a sweep task to bound the shared target directory ([16ff014](https://github.com/jaroslawherod/micold-ai-ide/commit/16ff0146afba5b5415fa813773307e7c3911715a))
* **gates:** run BUG-001's relayout gate on all three platforms ([1a76fb9](https://github.com/jaroslawherod/micold-ai-ide/commit/1a76fb9aa04b740fbf9939d618aa43131c6982db))
* run the assertion-freeze check on pull requests, advisory for now ([6d9c1ee](https://github.com/jaroslawherod/micold-ai-ide/commit/6d9c1eef6fecdd0278a6f1b1490a0a01bb69882e))
* share one target directory so worktree builds serialise ([0579aec](https://github.com/jaroslawherod/micold-ai-ide/commit/0579aec0030d6d28c080ef045519baadac2073c9))
