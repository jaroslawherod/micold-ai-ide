...
## [0.16.0](https://github.com/jaroslawherod/micold-ai-ide/compare/micold-ai-ide-v0.15.0...micold-ai-ide-v0.16.0) (2026-09-26)


### ⚠ BREAKING CHANGES

* **029:** the availability request names the directory it is for; protocol 13 -> 14 (BUG-001, T065)
...
* **029:** the availability request names the directory it is for; protocol 13 -&gt; 14 (BUG-001, T065) ([5134837](https://github.com/jaroslawherod/micold-ai-ide/commit/513483769f4c2d55894a3a0d0a28ca1ad27eec4e))
...
* **031:** a file address carries its host and its decoded path (U31, U32) ([8e70c2b](https://github.com/jaroslawherod/micold-ai-ide/commit/8e70c2bfde6f2b4807246f78b00593752dc5979a))
* **031:** a file link asks for its host path, an unreachable one says so (U78, U79) ([59ecd36](https://github.com/jaroslawherod/micold-ai-ide/commit/59ecd36e1906fce02402d6ebe749d9413012e445))
* **031:** a file link opens its document and reveals a runnable file (U95-U97, U146) ([20455ec](https://github.com/jaroslawherod/micold-ai-ide/commit/20455ec266a01d2d9f86f1e851165f269c34c548))
* **031:** a file link resolves to a path on this machine (U35, U37, U41) ([3caa715](https://github.com/jaroslawherod/micold-ai-ide/commit/3caa71515b2a8120de61143d9fcedbccb992045a))
* **031:** a runnable file is revealed, never run (U50-U55) ([89d493e](https://github.com/jaroslawherod/micold-ai-ide/commit/89d493e20dfb900384ae8c79989c00f2816f2dfe))
* **031:** boot names this machine and the pane's link context (U134, U136) ([ddfec8a](https://github.com/jaroslawherod/micold-ai-ide/commit/ddfec8a9b77302556a466825c15c8f1e4676d7b9))
...
* **031:** COLORTERM is matched unless it names a colour depth (U65) ([2606438](https://github.com/jaroslawherod/micold-ai-ide/commit/2606438f2d40872a4fcc597fc2ef0f1b2da3f65e))
...
* **031:** identity keys fold case only where the platform does (U66) ([9665088](https://github.com/jaroslawherod/micold-ai-ide/commit/9665088da5b195dffb3511900f021af3f6943eb4))
...
* **031:** include shells drop the inherited terminal identity (U67) ([02c58d4](https://github.com/jaroslawherod/micold-ai-ide/commit/02c58d498f745c76b1cde7f9dfa29e2eebdeff79))
...
* **031:** sessions drop the inherited terminal identity (U68) ([f6a1ab9](https://github.com/jaroslawherod/micold-ai-ide/commit/f6a1ab99014a24ab8a230b4d3a467c0d8cd47af6))
* **031:** the names a sandbox container answers to (U141) ([6c81f11](https://github.com/jaroslawherod/micold-ai-ide/commit/6c81f11507c64ad64792052eaf8fea04c9c782c5))
* **031:** the nine terminal identity keys are matched (U64) ([46aef15](https://github.com/jaroslawherod/micold-ai-ide/commit/46aef1507e85474761a16045d0f6d39c3c37a470))
* **031:** this machine's names for a file link's host (U140) ([e5adc8c](https://github.com/jaroslawherod/micold-ai-ide/commit/e5adc8c0a8a1e98ac2cdc50225913e4f037653b2))
...
* **032:** a later CLI title replaces a derived session label ([6c68ffe](https://github.com/jaroslawherod/micold-ai-ide/commit/6c68ffe3ccb12e4906e6116a4d6d322720d93286))
* **032:** a running session reads its label whichever signal arrives first ([76964d2](https://github.com/jaroslawherod/micold-ai-ide/commit/76964d24b7f0ce96c3197a8226afb5b8ac0810bc))
* **032:** cover Copilot in the user guide, the corpus probe and the TDD record ([b7f74fa](https://github.com/jaroslawherod/micold-ai-ide/commit/b7f74fada3e183036a0c7dfe63a4062b46da56dd))
* **032:** derived session label kind, store, wire and catalog seam ([41463b4](https://github.com/jaroslawherod/micold-ai-ide/commit/41463b4a64ec3969b3526f10e96a4d38ca346e61))
* **032:** label untitled claude sessions with their first typed turn ([98ebcd6](https://github.com/jaroslawherod/micold-ai-ide/commit/98ebcd6f23633f28fe901c39e7ce26558702176d))
* **032:** read Copilot's summary as a title and its first turn as a label ([a725b72](https://github.com/jaroslawherod/micold-ai-ide/commit/a725b721e572f6da2fa2b277624c833d131dabca))
* **032:** the first prompt always re-arms the live name lookup ([e2f479e](https://github.com/jaroslawherod/micold-ai-ide/commit/e2f479e93a10cca84a7637b49e52f6e6dae37b32))
...
* **013:** a create that fails after Cancel is reported as a notification (BUG-001 U6) ([359c001](https://github.com/jaroslawherod/micold-ai-ide/commit/359c0014147ad4443455cdec130bf6b8b3775c2d))
* **013:** a create that succeeds after Cancel is announced (BUG-001 U9) ([0530616](https://github.com/jaroslawherod/micold-ai-ide/commit/0530616db58113a79520ccd9917a7d8444947670))
* **013:** a create that succeeds after Cancel is announced with no project open (BUG-001 U14) ([ae07378](https://github.com/jaroslawherod/micold-ai-ide/commit/ae07378feed7f5fd79202652980fbd4c2d78216f))
* **013:** a failure after Cancel names the stage it failed at (BUG-001 U7) ([b3a27fc](https://github.com/jaroslawherod/micold-ai-ide/commit/b3a27fc2876577ebaa53792185dd8dfa4d551752))
* **013:** a protected dialog stops Escape reaching the Settings draft behind it (BUG-001 U3) ([9e9210c](https://github.com/jaroslawherod/micold-ai-ide/commit/9e9210c95bdc483da984210764c83282bce4953f))
* **013:** a stage reported after Cancel is the one a failure names (BUG-001 U8) ([a2d6ace](https://github.com/jaroslawherod/micold-ai-ide/commit/a2d6ace4dccd02524d95cbd6068d3b9b6c12d763))
* **013:** an idle Cancel no longer forgets a create cancelled earlier (BUG-001 U13) ([3d7f917](https://github.com/jaroslawherod/micold-ai-ide/commit/3d7f917e8dc8213da72c2eb8811066e8783ee514))
* **013:** the add-worktree dialog ignores Escape and the scrim while a create runs (BUG-001) ([9dd927a](https://github.com/jaroslawherod/micold-ai-ide/commit/9dd927a0e1f7edef630480ba9a48fa16832d7394))
...
* **027:** boot prunes with the placement it starts under (BUG-006, U39) ([c853550](https://github.com/jaroslawherod/micold-ai-ide/commit/c85355014051ca0af2594489cf9e12a948f0bd50))
...
* **027:** create the sign-in's directory in the sandbox home before the runtime runs (BUG-006, U35) ([4bf8806](https://github.com/jaroslawherod/micold-ai-ide/commit/4bf88060ea6015fe581ac0b8dc529e9b5321b3c4))
* **027:** create the sign-in's mount target before the runtime runs (BUG-006, U42) ([3656ece](https://github.com/jaroslawherod/micold-ai-ide/commit/3656ece3542ba1704815ac0e95fd150ad7daa246))
* **027:** do not mount a sign-in token this host does not have (BUG-006, U41) ([d49212c](https://github.com/jaroslawherod/micold-ai-ide/commit/d49212c8291d57020c5546d3e285b05ebcf3281d))
* **027:** mount the AI CLI sign-in token writable, every other credential read-only (BUG-006, U33) ([8e2dc19](https://github.com/jaroslawherod/micold-ai-ide/commit/8e2dc19b73909aa07027bd1a33d3a19b2594153b))
* **027:** name the sandbox-home directories a nested credential needs created first (BUG-006, U34) ([a06fdc3](https://github.com/jaroslawherod/micold-ai-ide/commit/a06fdc365a024859e7612dd5ffd2e15c52525efb))
...
* **027:** read the settings once at launch (BUG-006, U40) ([30c18b5](https://github.com/jaroslawherod/micold-ai-ide/commit/30c18b564cfb35c0a0c406c45354d0bcaf2feaa5))
* **027:** say the shared AI CLI sign-in can be replaced by a session (BUG-006, U38) ([2f2a3af](https://github.com/jaroslawherod/micold-ai-ide/commit/2f2a3af1ea873b709d1d194211c8fe17c8087aef))
* **027:** share only the AI CLI sign-in token file with the sandbox (BUG-006, U32) ([1641881](https://github.com/jaroslawherod/micold-ai-ide/commit/164188163c4c857ec5d854f62e569e6c6d52c266))
* **027:** the boot prune leaves sandboxed sessions to the daemon (BUG-006, U36) ([8d5a8c5](https://github.com/jaroslawherod/micold-ai-ide/commit/8d5a8c56a2c022149e571ca5158a30e478752152))
* **027:** the sandbox stands down from judging sessions, not from tidying (BUG-006, U43) ([a7404cc](https://github.com/jaroslawherod/micold-ai-ide/commit/a7404cc32b66d32f36635252b76a181afa556b9e))
* **029:** a /rename is the current name, not the ai-title it replaced (BUG-002) ([35f8075](https://github.com/jaroslawherod/micold-ai-ide/commit/35f80756296d464c28c354e0e1debf470244aac0))
* **029:** a late availability answer never replaces a newer one (BUG-001 U13) ([75e018c](https://github.com/jaroslawherod/micold-ai-ide/commit/75e018c2ee007c9f910a04b69d355f179f8244bb))
* **029:** a slow environment never holds up the connection loop (BUG-001 U10) ([984b128](https://github.com/jaroslawherod/micold-ai-ide/commit/984b12833aca30a89b9a70cad7c06b3186a9460e))
* **029:** resolve agent-name and ai-title by position, not by kind (BUG-002) ([0089091](https://github.com/jaroslawherod/micold-ai-ide/commit/008909155f5504941fdff787587f359f74e8ae3a))
* **029:** review fixes and the BUG-001 verification record (T070, T075) ([fc841f0](https://github.com/jaroslawherod/micold-ai-ide/commit/fc841f03a3a8eaaac23a0c1237d13c915704d79a))
* **029:** the launch gate checks the PATH the session is spawned with (BUG-001 A2, U8) ([f92fce8](https://github.com/jaroslawherod/micold-ai-ide/commit/f92fce842109f06d77a84a49bb6afeb987d759e5))
* **029:** the service offers a CLI a session in that directory would find (BUG-001 A1, U9) ([7a17332](https://github.com/jaroslawherod/micold-ai-ide/commit/7a17332750b409adac52244d774d4797fbd64060))
* **029:** the start menu asks which CLIs its directory offers (BUG-001 U11) ([081a8a2](https://github.com/jaroslawherod/micold-ai-ide/commit/081a8a254d619137b553b7146786728495ef6bd9))
...
* **031:** a trailing dot, a folder, a bad escape and a bare drive never run or mislead (review A1-A3, B4) ([01e1a55](https://github.com/jaroslawherod/micold-ai-ide/commit/01e1a5562ebfcf4694539cab9c3cb0edf744a402))
* **031:** drop a non-UTF-8 inherited identity variable too (U162) ([c3b1f5e](https://github.com/jaroslawherod/micold-ai-ide/commit/c3b1f5e6f02daedac573e4f3d4d9d79ca9d13758))
...
* **031:** the review round — a confirmed path, the boot read, the sandboxed arm and FR-013's whole list ([9f28939](https://github.com/jaroslawherod/micold-ai-ide/commit/9f289399ca0a9e06d2797c78dd5785e6bc5de0ad))
* **031:** the Windows stand-in is a compiled exe, not a .cmd CreateProcessW refuses ([21fc6b2](https://github.com/jaroslawherod/micold-ai-ide/commit/21fc6b259c90c99211e5919874801dea42335c4b))
* **032:** a quoted Copilot title beginning with &gt; is not a block scalar ([a421c26](https://github.com/jaroslawherod/micold-ai-ide/commit/a421c26705c80d4a94a74f0704953757fa419fa9))
...
* bump aho-corasick from 1.1.4 to 1.1.5 ([6bc9186](https://github.com/jaroslawherod/micold-ai-ide/commit/6bc91866a399eeb3f05004c98fb7b133c408fc77))
* bump android_system_properties from 0.1.5 to 0.1.6 ([2e9d092](https://github.com/jaroslawherod/micold-ai-ide/commit/2e9d092f498618dcca8d5532e147168fafa9be20))
* bump async-trait from 0.1.91 to 0.1.92 ([ccac63a](https://github.com/jaroslawherod/micold-ai-ide/commit/ccac63a10992b441ac9f3a187f307480647aba9e))
* bump bitflags from 2.13.1 to 2.13.2 ([aa2e5c9](https://github.com/jaroslawherod/micold-ai-ide/commit/aa2e5c97dd6f3345e628b40a0fb3f0480ffdb62c))
* bump blocking from 1.6.2 to 1.7.0 ([ae6f4d7](https://github.com/jaroslawherod/micold-ai-ide/commit/ae6f4d78aa933d96f35fa77cc650d6d132b2615c))
* bump bytemuck_derive from 1.11.0 to 1.12.1 ([1c3cc09](https://github.com/jaroslawherod/micold-ai-ide/commit/1c3cc09b4290fb443cf276c46bf40aa47d2bfede))
* bump cc from 1.4.0 to 1.4.7 ([32c4c8e](https://github.com/jaroslawherod/micold-ai-ide/commit/32c4c8e99a62be56bc04d22e4ea2ecc19ee8ad8e))
* bump cfg-if from 1.0.4 to 1.0.5 ([eafead1](https://github.com/jaroslawherod/micold-ai-ide/commit/eafead1330bf5880f15b73f6e0d6a1cfc7573bfa))
* bump combine from 4.6.7 to 4.6.8 ([bd5f48f](https://github.com/jaroslawherod/micold-ai-ide/commit/bd5f48f7c35cf6c73e04e636b224491937d3a60d))
* bump crc32fast from 1.5.0 to 1.5.2 ([f334be5](https://github.com/jaroslawherod/micold-ai-ide/commit/f334be527aec5febaec2f25cbd239d647d80d4bb))
* bump crossbeam-utils from 0.8.22 to 0.8.23 ([64b65e6](https://github.com/jaroslawherod/micold-ai-ide/commit/64b65e6746bb3ba7f05fc98e414920b4ba477153))
* bump error-code from 3.3.2 to 3.4.0 ([dd43c09](https://github.com/jaroslawherod/micold-ai-ide/commit/dd43c0935bfa565cb39a65e78a2fb73df27681df))
* bump flate2 from 1.1.9 to 1.1.10 ([857455d](https://github.com/jaroslawherod/micold-ai-ide/commit/857455dbd3fe6bf3cfb3a719fbb26a0a52963d6e))
* bump font-types from 0.12.2 to 0.12.5 ([b8fccc3](https://github.com/jaroslawherod/micold-ai-ide/commit/b8fccc39c0d360ce040842ecac2fb6e9ebfc082f))
* bump futures from 0.3.33 to 0.3.34 ([b7d1584](https://github.com/jaroslawherod/micold-ai-ide/commit/b7d1584b0a88ab48ea97dda2b3ae50c9d7cc3e2c))
* bump hermit-abi from 0.5.2 to 0.5.3 ([e514301](https://github.com/jaroslawherod/micold-ai-ide/commit/e51430173fab72890ab56148f7186e786593eaca))
* bump iced_winit from 0.14.0 to 0.14.1 ([2293555](https://github.com/jaroslawherod/micold-ai-ide/commit/22935559d6cf8dffabeac8e221e7e086b312bee7))
* bump indexmap from 2.14.0 to 2.14.2 ([15d95d5](https://github.com/jaroslawherod/micold-ai-ide/commit/15d95d5b310ccbbc9f4c924877a632f6506e167b))
* bump libredox from 0.1.18 to 0.1.24 ([507b902](https://github.com/jaroslawherod/micold-ai-ide/commit/507b9025c30a92b3ea94b1cf216c813283d506c2))
* bump libredox from 0.1.24 to 0.1.25 ([5048cc2](https://github.com/jaroslawherod/micold-ai-ide/commit/5048cc29366f038bf41733ce417d6760957967a3))
* bump lilt from 0.8.1 to 0.8.2 ([7085073](https://github.com/jaroslawherod/micold-ai-ide/commit/7085073c9ce2ae780921ab64cd20d37f5727e4a4))
* bump log from 0.4.33 to 0.4.34 ([128ca5e](https://github.com/jaroslawherod/micold-ai-ide/commit/128ca5e4186731762dfa4f34f939ec6b4f07d500))
* bump lyon_algorithms from 1.0.20 to 1.0.21 ([5e546b9](https://github.com/jaroslawherod/micold-ai-ide/commit/5e546b973c9da908b8f27cb4fc4f4c042fd7da38))
* bump lyon_tessellation from 1.0.20 to 1.0.22 ([a9a9a54](https://github.com/jaroslawherod/micold-ai-ide/commit/a9a9a544f40527b7431a74b9a00604b3f3b52e79))
* bump mio from 1.2.2 to 1.2.3 ([bfe7871](https://github.com/jaroslawherod/micold-ai-ide/commit/bfe78716dab1e2e954778d1172c2a7722cf05032))
* bump ordered-float from 5.3.0 to 5.5.0 ([06277be](https://github.com/jaroslawherod/micold-ai-ide/commit/06277be28720214ec522e6501e0452797a6983fe))
* bump pkg-config from 0.3.33 to 0.3.34 ([66eff6b](https://github.com/jaroslawherod/micold-ai-ide/commit/66eff6bcb17870405447df283f658e46ae978598))
* bump portable-atomic from 1.14.0 to 1.15.0 ([e4dbd00](https://github.com/jaroslawherod/micold-ai-ide/commit/e4dbd004d9a9e230b0621da754185dae8a965738))
* bump portable-atomic-util from 0.2.7 to 0.2.8 ([f7b598a](https://github.com/jaroslawherod/micold-ai-ide/commit/f7b598ad2febbff7101a3d4606dc01fe6ec356f6))
* bump rangemap from 1.7.1 to 1.8.0 ([c31848f](https://github.com/jaroslawherod/micold-ai-ide/commit/c31848fd78f76c1616f22f697e585f15a1575b78))
* bump redox_users from 0.5.2 to 0.5.3 ([2a1eff5](https://github.com/jaroslawherod/micold-ai-ide/commit/2a1eff56bb3264f6c0408ec50ec9d8c844db4a84))
* bump regex-automata from 0.4.16 to 0.4.18 ([0eccd18](https://github.com/jaroslawherod/micold-ai-ide/commit/0eccd18efd4051df3d0aadb84cfb52e527f06f5a))
* bump rustix from 1.1.4 to 1.1.5 ([ec0a492](https://github.com/jaroslawherod/micold-ai-ide/commit/ec0a4924ecd9e54d6eba70bee8c745bd1c8e62f4))
* bump serial2 from 0.2.37 to 0.2.38 ([038faf6](https://github.com/jaroslawherod/micold-ai-ide/commit/038faf6f0b911f42fed2e7b16c569fa6f798440d))
* bump smallvec from 1.15.2 to 1.16.1 ([02359d8](https://github.com/jaroslawherod/micold-ai-ide/commit/02359d88df5abf2a147a0dcd1db05ddaf3d3770d))
* bump syn from 3.0.3 to 3.0.6 ([f68d1a0](https://github.com/jaroslawherod/micold-ai-ide/commit/f68d1a036cd236e3659ae9f4699139ac40f9f10f))
* bump the wasm-bindgen family from 0.2.126 to 0.2.128 ([14a99a8](https://github.com/jaroslawherod/micold-ai-ide/commit/14a99a8b748de730ff66848d6fac804988405bb1))
* bump thiserror from 2.0.19 to 2.0.20 ([bcdb696](https://github.com/jaroslawherod/micold-ai-ide/commit/bcdb696c6cb3fa76e49ff6aa06d0944180b4eec4))
* bump tinyvec from 1.12.0 to 1.13.3 ([f238d34](https://github.com/jaroslawherod/micold-ai-ide/commit/f238d34bfb43a1d9acd80abba4842118cf368d81))
* bump tokio-macros from 2.7.1 to 2.7.2 ([951ae27](https://github.com/jaroslawherod/micold-ai-ide/commit/951ae2718a5fd253b43b366b5aa10a87fd74c183))
* bump toml_edit from 0.25.13+spec-1.1.0 to 0.25.15+spec-1.1.0 ([b7f0ae4](https://github.com/jaroslawherod/micold-ai-ide/commit/b7f0ae46bb0ae3c582ab18413b0dbf5b279b61d7))
* bump unicode-ident from 1.0.24 to 1.0.26 ([dca4825](https://github.com/jaroslawherod/micold-ai-ide/commit/dca4825544ff2b2bf40f3bbb6190df0c2b19c79b))
* bump wayland-backend from 0.3.16 to 0.3.17 ([f520b4a](https://github.com/jaroslawherod/micold-ai-ide/commit/f520b4a9ed9a8fa7c644954b4a3ba9a2c9a39494))
* bump xcursor from 0.3.10 to 0.3.11 ([4262e73](https://github.com/jaroslawherod/micold-ai-ide/commit/4262e730aca9a8088689b972cb6efb3b0e857519))
* bump xml-rs from 0.8.28 to 0.8.29 ([45f3026](https://github.com/jaroslawherod/micold-ai-ide/commit/45f302662ce2e09e439bbe6224ead5e8dce9269c))
* bump zerocopy from 0.8.55 to 0.8.57 ([b56b1a7](https://github.com/jaroslawherod/micold-ai-ide/commit/b56b1a77ab1eba02edca670e2420893759984b0c))
