...
impl RuntimeTerminal {
    ...
    pub fn key_term_mode(&self) -> crate::keymap::TermMode {
        let mode = self.term.renderable_content().mode;
        crate::keymap::TermMode {
...
pub fn spawn_shell_pty(
    ...
    let command =
        micold_core::terminal::default_shell_command(shell_env.as_deref(), comspec_env.as_deref());
...
pub struct SessionTerminals {
    ...
    pub shells: std::collections::HashMap<micold_core::session::ShellInstanceId, RuntimeTerminal>,
}
...
impl SessionTerminals {
    ...
    pub fn attached(
        &self,
        mode: micold_core::session::TerminalMode,
        active_shell: Option<micold_core::session::ShellInstanceId>,
    ) -> Option<&RuntimeTerminal> {
        match mode {
            micold_core::session::TerminalMode::AiCli => self.ai_cli.as_ref(),
            micold_core::session::TerminalMode::Regular => self.shells.get(&active_shell?),
        }
    }
    ...
    pub fn attached_mut(
        ...
        match mode {
            micold_core::session::TerminalMode::AiCli => self.ai_cli.as_mut(),
            micold_core::session::TerminalMode::Regular => self.shells.get_mut(&active_shell?),
        }
    }
    ...
    /// untouched.
    pub fn close_shell(&mut self, id: micold_core::session::ShellInstanceId) {
