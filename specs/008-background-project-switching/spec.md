...
- **FR-004**: The system MUST provide a project switcher control in the top app bar, positioned immediately adjacent to the existing menu button. That control is the **shared icon button**, identical to the menu button beside it, per [018](../018-material3-visual-system/spec.md) FR-029c — this requirement never asked for a text label, and the label the implementation carried made the switcher a bespoke widget that missed every improvement the shared button received. *(Amended by [018's BUG-007](../018-material3-visual-system/bugs/BUG-007.md), which also drops the label: the active project's name moves to the control's tooltip, and FR-006 is carried where it always was — by the panel's active marker.)*
