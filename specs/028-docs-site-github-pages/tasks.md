...
- [ ] T062 [US4] Write `docs/development/docs-site.md` — how a publication works, what each check catches, how to trigger a republish, and why the trigger is a reusable workflow rather than a release event — and add its `docs/SUMMARY.md` entry (Principle VII)
