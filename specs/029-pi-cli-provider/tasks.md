...
- [X] T065 [BUG-001] `crates/micold-core/src/protocol/messages.rs`: add `cwd: Option<PathBuf>` to `ClientMsg::AiCliAvailabilityRequest`, bump `PROTOCOL_VERSION` 13 → 14 in `crates/micold-core/src/protocol/version.rs`, and regenerate the schema hash
