...
- **Started**: 2026-09-19
- **Phase**: 4-milestones
- **Next step**: M3 PR #399 open, waiting for CI; then Phase 5 (close: converge, tdd-verify, docguard)
...
| #399 | M3 — a running session reads its label whichever signal arrives first | open | — |
...
| M3 | T028–T030, T044, T047, T039–T041 | A running session shows its label within a minute of the first prompt, spinner first or not (US3); Polish, quickstart §B1 (Copilot) + §B3 recorded | #399 | open |
